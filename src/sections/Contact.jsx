              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-3 p-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    <FaWhatsapp className="w-5 h-5 flex-shrink-0" />
                    <div>
                      <h4 className="text-sm font-semibold mb-0.5">{t.contact.whatsapp_label}</h4>
                      <p className="text-xs opacity-90">{t.contact.whatsapp_sub}</p>
                    </div>
                  </motion.a>
                </div>
              </div>
